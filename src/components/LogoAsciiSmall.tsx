...
const LogoSvg = () => {
  ...
  return (
    <group position={[1, 0.25, -1]} scale={[-1 / 300, -1 / 300, 1]}>
...
const LogoAsciiSmall: React.FC<LogoAsciiSmallProps> = ({ className, style, ...props }) => (
  <motion.div
...
LogoAsciiSmall.displayName = 'LogoAsciiSmall'
