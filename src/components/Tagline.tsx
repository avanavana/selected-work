...
const Tagline: React.FC<TaglineProps> = ({ animated = true, className, isDarkMode = false,size = 'default', ...props }) => {
  const { resolvedTheme } = useTheme()

  return (
    <div className={cn('[&_>_*]:absolute [&_svg]:absolute', taglineSizes[size].widthClass, taglineSizes[size].heightClass, className)} {...props}>
      <svg width={taglineSizes[size].width} height={taglineSizes[size].height} viewBox='0 0 600 45' fill='none' xmlns='http://www.w3.org/2000/svg'>
        {animated ? [
          <motion.path
            ...
            stroke={resolvedTheme === 'dark' ? colors['gray-600'] : colors['gray-200']}
          ...
          <path key='divider-top' d='M222.105 22.5001 210.132 44.0283' stroke={resolvedTheme === 'dark' ? colors['gray-600'] : colors['gray-200']} strokeWidth={taglineSizes[size].stroke} />,
          <path key='divider-bottom' d='M222.105 22.5001L234.079 0.971863' stroke={resolvedTheme === 'dark' ? colors['gray-600'] : colors['gray-200']} strokeWidth={taglineSizes[size].stroke} />
        ]}
      </svg>
      <div
        style={{ width: taglineSizes[size].width, height: taglineSizes[size].height }}
        className={cn(
          '[transform:translateZ(0)] [will-change:transform]',
          { '[clip-path:polygon(38.85%_0%,_34.62%_100%,_0%_100%,_0%_0%)] [-webkit-clip-path:polygon(38.85%_0%,_34.62%_100%,_0%_100%,_0%_0%)]': animated }
        )}
      >
        <svg width={taglineSizes[size].width} height={taglineSizes[size].height} viewBox='0 0 600 45' fill='none' xmlns='http://www.w3.org/2000/svg'>
          {animated ? (
            <motion.path
              ...
              fill={resolvedTheme === 'dark' ? colors['gray-500'] : colors['gray-800']}
              initial={{ x: 300 }}
              animate={{ x: 0 }}
              transition={{
                delay: 10.5,
      ...
      <div
        ...
        className={cn(
          '[transform:translateZ(0)] [will-change:transform]',
          { '[clip-path:polygon(39.39%_0%,_100%_0%,_100%_100%,_35.2%_100%)] [-webkit-clip-path:clip-path:polygon(39.39%_0%,_100%_0%,_100%_100%,_35.2%_100%)]': animated }
        )}
      >
        <svg width={taglineSizes[size].width} height={taglineSizes[size].height} viewBox='0 0 600 45' fill='none' xmlns='http://www.w3.org/2000/svg'>
          {animated ? (
